...
const About = () => {
  return (
    <div className='w-full h-screen bg-[#1e1e1e] flex flex-col gap-8 p-5 overflow-scroll pb-16 sm:pb-0 sm:overflow-scroll sm:p-16 lg:w-1/2'>
      ...
      >
        <p>
          👋 Hello! I'm Abdulazeez Mahmud Enesi, a passionate junior front-end
          developer and an aspiring technical writer.
          <br />
          🎓 I hold a B. Eng. in Metallurgical and Materials Engineering from
          Ahmadu Bello University (ABU) and proudly a Graduate Member of the
          Nigeria Society of Engineers (GMNSE).
          <br />
